...
window.__WEATHER_CONFIG__ = {
  ...
  METNORWAY_ENABLED: "${METNORWAY_ENABLED:-true}",
  PIRATEWEATHER_ENABLED: "${PIRATEWEATHER_ENABLED:-false}",
...
echo "  - MET Norway: ${METNORWAY_ENABLED:-true}"
echo "  - Pirate Weather: ${PIRATEWEATHER_ENABLED:-false}"
